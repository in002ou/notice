...
public class NoticeServiceImpl implements NoticeService {
	...
	public int modifyNotice(HttpServletRequest request) {
		NoticeDTO notice = new NoticeDTO(Integer.parseInt(request.getParameter("notice_no")), Integer.parseInt(request.getParameter("gubun")), request.getParameter("title"), request.getParameter("content"));
